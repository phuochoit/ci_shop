...
<div class="box-right">
    ...
    <div class="content-box">
        ...
        <div class="support">
            ...
            <p>
                <img style="margin-bottom:-3px" src="<?php print public_url()?>/site/images/phone.png"> 01686039488	      
            </p>
            <p>
                <a rel="nofollow" href="mailto:hoangvantuyencnt@gmail.com">
                <img style="margin-bottom:-3px" src="<?php print public_url()?>/site/images/email.png"> Email: hoangvantuye...
                </a>
            </p>
            <p>
                <a rel="nofollow" href="skype:tuyencnt90">
                <img style="margin-bottom:-3px" src="<?php print public_url()?>/site/images/skype.png"> Skype: tuyencnt90			</a>
            </p>
        </div>
    </div>
</div>
    ...
    <div class="content-box">
        <ul class="news">
            <li>
                ...
                <img src="<?php print public_url()?>/site/images/li.png">
...
<div class="box-right">
    ...
    <div class="content-box">
        <a href="">
        <img src="<?php print public_url()?>/site/images/ads.png">
        </a>
    </div>
</div>
<!-- End Ads -->
