<!-- The box-header-->
<link type="text/css" href="<?php print public_url()?>/js/jquery/autocomplete/css/smoothness/jquery-ui-1.8.16.custom.css" rel="stylesheet">
<script type="text/javascript" src="<?php print public_url()?>/js/jquery/autocomplete/jquery-ui-1.8.16.custom.min.js"></script>
...
<div class="top">
	...
	<div id="logo">
		...
		<img src="<?php print public_url()?>/site/images/logo.jpg" alt="Học lập trình website với PHP và MYSQL">
		</a>
	</div>
	<!-- End logo -->
	<!--  load gio hàng -->
	<div id="cart_expand" class="cart"> 
		...
		<img alt="cart bnc" src="<?php print public_url()?>/site/images/cart.png"> 
	</div>
	<div id="search">
		<!-- the search -->
