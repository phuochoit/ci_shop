...
<div class="wrapper">
	<!-- Form -->
	<form class="form" id="form" action="<?php print admin_url('product/add');?>" method="post" enctype="multipart/form-data">
		<fieldset>
			<div class="widget">
				<div class="title">
				...
				<div class="tab_container">
					<div id="tab1" class="tab_content pd0">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left"><input id="image_link" name="image_link" type="file"></div>
								...
								<select name="catalog" _autocheck="true" id="param_catalog" class="left">
									...
									<optgroup label="<?php print $val->name;?>">
										<?php foreach ($val->subs as $ks => $vals) :?>
                                            <option value="<?php print $vals->id;?>"> <?php print $vals->name;?></option>
                                        <?php endforeach;?>
                                    </optgroup>
                                    <?php else :?>
