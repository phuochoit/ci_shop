...
<div class="wrapper">
   <div class="widgets">
      ...
      <div class="oneTwo">
         <div class="widget">
            <div class="title">
               <img src="<?php print public_url('/admin/')?>/images/icons/dark/money.png" class="titleIcon">
               <h6>Doanh số</h6>
            </div>
      ...
      <div class="oneTwo">
         <div class="widget">
            <div class="title">
               <img src="<?php print public_url('/admin/')?>/images/icons/dark/users.png" class="titleIcon">
      ...
      <div class="widget">
         <div class="title">
            <span class="titleIcon">
               <div class="checker" id="uniform-titleCheck"><span><input id="titleCheck" name="titleCheck" style="opacity: 0;" type="checkbox"></span></div>
            </span>
         ...
         <table class="sTable mTable myTable" id="checkAll" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tbody class="list_item">
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="21" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="20" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="19" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="18" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="17" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="16" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="15" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="14" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="13" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
               ...
               <tr>
                  <td>
                     <div class="checker" id="uniform-undefined"><span><input name="id[]" value="12" style="opacity: 0;" type="checkbox"></span></div>
                  </td>
