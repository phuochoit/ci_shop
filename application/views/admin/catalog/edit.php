        ...
        <form id="form" class="form" action="" method="post" enctype="multipart/form-data">
           <fieldset>
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <input name="name" id="param_name" _autocheck="true" type="text" value="<?php print $info->name;?>"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <input name="sort_order" id="param_sort_order" _autocheck="true" type="text" value="<?php print $info->sort_order;?>"></span>
                        <span name="name_autocheck" class="autocheck"></span>
                    ...
                    <div class="formRight">
                        <select name="parent_id" _autocheck="true" id="param_parent_id" class="left">
                            ...
                            <?php foreach ($list as $k => $val) : ?>
                                 <option value="<?php print $val->id;?>" <?php print ($val->id == $info->parent_id) ? 'selected' : '';?>><?php print $val->name;?> </option> 
                            <?php endforeach;?>
					    </select>
                        <span name="name_autocheck" class="autocheck"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <input name="site_title" id="param_ssite_title" _autocheck="true" type="text" value="<?php print $info->site_title;?>">
                        </span>
                        <span name="name_autocheck" class="autocheck"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <textarea name="meta_desc" id="meta_desc" rows="4" cols=""><?php print $info->meta_desc;?></textarea>
                        </span>
                        <span name="name_autocheck" class="autocheck"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo">
                            <textarea name="meta_key" id="meta_key" rows="4" cols=""><?php print $info->meta_key;?></textarea>
                        </span>
                        <span name="name_autocheck" class="autocheck"></span>
